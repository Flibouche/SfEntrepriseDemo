...
-- Listage de la structure de la table sfentreprisedemo. doctrine_migration_versions
...
INSERT INTO `doctrine_migration_versions` (`version`, `executed_at`, `execution_time`) VALUES
	('DoctrineMigrations\\Version20240530133752', '2024-05-30 13:39:42', 83);

-- Listage de la structure de la table sfentreprisedemo. employe
...
-- Listage de la structure de la table sfentreprisedemo. entreprise
...
INSERT INTO `entreprise` (`id`, `raison_sociale`, `date_creation`, `adresse`, `cp`, `ville`) VALUES
	(1, 'ELAN FORMATION', '1990-07-10 16:17:47', '14 rue du Rhône', '67100', 'STRASBOURG'),
	(2, 'COACTIS', '2015-07-10 16:18:11', '10 rue de la Charmu ', '67100', 'STRASBOURG'),
	(3, 'ENTREPRISE', '2010-05-30 16:18:46', '10 rue Principale', '75000', 'PARIS');

-- Listage de la structure de la table sfentreprisedemo. messenger_messages
